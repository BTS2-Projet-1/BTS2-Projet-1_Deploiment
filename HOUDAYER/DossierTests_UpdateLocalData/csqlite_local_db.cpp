 ...
 *
 * @startuml{CSQLite_Local_DB--Builder.svg}
 *
 *  autonumber
...
bool CSQLite_Local_DB::Connect_DB()
{
    ...
    {
        qDebug() << "[SUCCESS] : The database file is founded, opening...";
        // Find QSLite driver
    ...
    else
    {
         ...
         {
             qDebug() << "[WARNING] : The database file is missing but the database save file founded, building the new database...";
         ...
         else
         {
             if(SQL_DB_Empty_File.exists() && SQL_DB_Test_File.exists())
             {
                 ...
                 {
                     qDebug() << "[WARNING] : The database file is missing but SQL_files founded, building the new database...";
                     Result = true;
                 }
             }
             else
...
bool CSQLite_Local_DB::Close_Database(bool Delete_Database)
{
    bool Result = false;
